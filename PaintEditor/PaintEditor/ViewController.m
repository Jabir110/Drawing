...
-(void)initResetAndSaveButton
{
    ...
    resetButton.frame = CGRectMake(self.view.frame.size.width*2.1/10, self.view.frame.size.height*0.35/10,self.view.frame.size.height*1.2/10, self.view.frame.size.width*1/10);
    
    [resetButton setImage:[UIImage imageNamed:@"Clear.png"] forState:UIControlStateNormal];
...
//    resetButton.titleLabel.font = [UIFont systemFontOfSize:22];
    ...
    settingButton.frame = CGRectMake(self.view.frame.size.width*4.5/10, self.view.frame.size.height*0.35/10,self.view.frame.size.width*1.2/10, self.view.frame.size.width*1/10);
    ...
    saveButton.frame = CGRectMake(self.view.frame.size.width*6.0/10, self.view.frame.size.height*0.35/10,self.view.frame.size.height*1.2/10, self.view.frame.size.width*1/10);
...
//    saveButton.titleLabel.font = [UIFont systemFontOfSize:22];
    ...
    undoButton.frame = CGRectMake(self.view.frame.size.width*0.1/10, self.view.frame.size.height*0.35/10, self.view.frame.size.height*1.2/10, self.view.frame.size.width*1/10);
...
//    undoButton.titleLabel.font = [UIFont systemFontOfSize:22];
    ...
    redoButton.frame = CGRectMake(self.view.frame.size.width*8/10, self.view.frame.size.height*0.35/10,self.view.frame.size.height*1.2/10, self.view.frame.size.width*1/10);
